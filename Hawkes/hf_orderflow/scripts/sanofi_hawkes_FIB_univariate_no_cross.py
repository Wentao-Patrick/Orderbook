...
# Script role: univariate Hawkes LR test on merged order flow with FIB bootstrap.
...
def main():
    ...
    if not args.skip_diagnostics:
        ...
        out1 = save_rescaling_outputs(v1, prefix="half1_uni", results_dir=results_dir, figures_dir=figures_dir)
        out2 = save_rescaling_outputs(v2, prefix="half2_uni", results_dir=results_dir, figures_dir=figures_dir)
    ...
    lr_star_csv = results_dir / "LR_star_FIB_univariate.csv"
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    lr_hist_png = figures_dir / "LR_star_FIB_univariate_hist.png"
