...
# Script role: run a two-half bivariate Hawkes change test with parametric bootstrap.
...
def main():
    ...
    ap.add_argument("--buy_csv", default=str(DEFAULT_BUY_CSV))
    ap.add_argument("--sell_csv", default=str(DEFAULT_SELL_CSV))
