...
# Script role: fixed-beta bivariate Hawkes LR test with FIB bootstrap and diagnostics.
...
def save_rescaling_plots(v: np.ndarray, prefix: str, figures_dir: Path) -> dict:
    out = {}
...
def main():
    ...
    if args.do_diagnostics:
        ...
        out1 = save_rescaling_plots(v1, prefix="half1", figures_dir=figures_dir)
        out2 = save_rescaling_plots(v2, prefix="half2", figures_dir=figures_dir)
    ...
    lr_star_csv = results_dir / "LR_star_FIB.csv"
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    lr_hist_png = figures_dir / "LR_star_FIB_hist.png"
